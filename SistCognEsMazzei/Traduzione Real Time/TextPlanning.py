...
#per costruire espressioni che caratterizzano la semantica 
#delle frasi in input che sono producibili dalla grammatica G2
#Semantica espressa in First Order Logic + lambda-expressions per esprimere i terminali
...
if len(sys.argv)>1: 
    ...
    for line in INPUT: 
        ...
        #frasi di esempio da cui e' stata derivata la grammatica
